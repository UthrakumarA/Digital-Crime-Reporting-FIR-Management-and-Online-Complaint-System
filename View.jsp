...
<div class="complaints-container">
  <%
    String ackNumber = request.getParameter("ackNumber");

    if (ackNumber == null || ackNumber.trim().isEmpty()) {
  %>
      <p style="color:red; text-align:center;">Acknowledgement number is required.</p>
  <%
    } else {
      try {
        ...
        String query = "SELECT * FROM Complaint_report WHERE ack_number = ?";
        PreparedStatement ps = con.prepareStatement(query);
        ps.setString(1, ackNumber.trim());
  ...
  %>
      <div class="complaint">
        <p><strong>Acknowledgement No:</strong> <%= ackNumber %></p>
  ...
  <%
        ...
        if (!found) {
          out.println("<p style='text-align:center;color:red;'>No complaint found for Acknowledgement Number: <strong>" + ackNumber + "</strong></p>");
        }
